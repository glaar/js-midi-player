...
function Track(track_data, midi) {
  ...
  /* delete variables because they are ugly and are no longer needed */
  delete this.data;
  delete this.tracker;
}
...
function Midi(file) {
  ...
  /* hide some variables because they are ugly */
  delete this.data;
  delete this.tracker;
...
function read_byte() {
  return this.data[this.tracker++].charCodeAt(0);
}
